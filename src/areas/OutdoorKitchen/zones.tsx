...
export function Striplights({ onClick }) {
  return <svg viewBox="198.576 323.948 344.209 351.078" xmlns="http://www.w3.org/2000/svg">
    <Glow />
    <path onClick={onClick} d="M 200.576 320.948 L 345.532 450.689 L 345.888 513.27 L 200.703 365.131 L 200.576 320.948 Z"/>
    <path onClick={onClick} d="M 446.165 546.756 C 446.165 546.756 540.573 641.948 544.769 642.534 C 545.965 643.12 539.32 690.026 539.32 690.026 L 444.01 600.268 L 446.165 566.756 Z"/>
  </svg>
}
