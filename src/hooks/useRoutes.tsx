...
import { useHass, useHash, useEntity } from '@hakit/core';
import {
  Office,
  Dining,
  Living,
...
export function useRoutes() {
  ...
  }, [garageTemp.attributes.unit_of_measurement, garageTemp.state, hash, kitchenTemp.attributes.unit_of_measurement, kitchenTemp.state, lastUpdated, livingTemp.attributes.unit_of_measurement, livingTemp.state, masterTemp.attributes.unit_of_measurement, masterTemp.state, officeTemp.attributes.unit_of_measurement, officeTemp.state, routes]);
