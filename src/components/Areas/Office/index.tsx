...
import { Computer, RoofLight, Downlights, Striplights } from "./zones";
  ...
  const zones: ZoneProps[] = [
    {
      ...
      entities: {
        switch: "switch.switch_office_downlights",
    ...
    },
    {
      ...
      entities: {
        switch: "switch.switch_office_striplights",
    ...
    },
    {
      ...
      entities: {
        switch: "switch.switch_office_roof_light",
